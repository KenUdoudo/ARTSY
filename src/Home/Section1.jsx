...
const Section1home = () => {
  return (
    ...
    <div className="flex flex-col justify-center items-center gap-y-5 text-center mt-5 mx-10 md:mx-0">
      ...
      <p className='text-sm md:text-lg md:px-20 lg:px-40 sm:text-base font-rale'>Flip through more than 10,000 vintage shots, old photographs, historic images and captures seamlessly in one place. Register to get top access.</p>
