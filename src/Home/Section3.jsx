...
const Section3home = () => {
  return (
    <div className="static mt-40">
      ...
      <hr className="mt-20 mx-10 md:mx-20" />
      <div className="flex flex-row justify-between items-center  mt-8 mx-10 sm:mx-20">
        <h3 className="text-xl md:text-2xl">Explore Marketplace.</h3>
        <img src={ blueArrow } className="w-10 h-10"/>
      </div>
      <hr className="mt-10 mx-10 md:mx-20" />
      <div className="flex flex-row justify-between items-center  mt-8 mx-10 sm:mx-20">
        <h3 className="text-xl md:text-2xl">See auctions.</h3>
        <img src={ blueArrow } className="w-10 h-10"/>
      </div>
    </div>
  );
